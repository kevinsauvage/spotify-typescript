...
import { PlaylistResponseInterface, PlaylistTracksInterface, TrackInterface } from '@/types';
...
const Page: React.FC<PageInterface> = async ({ params, searchParams }) => {
  ...
  const [playlist, playlistTracks]: [PlaylistResponseInterface, PlaylistTracksInterface] =
    await Promise.all([
